...
import 'package:school_room/Feature/Student/Groups/presentation/widgets/student_chat_groups_title_app_bar_widget.dart';
...
class StudentGroupConversationScreen extends StatelessWidget{
  const StudentGroupConversationScreen({super.key});
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const StudentChatGroupsTitleAppBar(),
          actions: const [
