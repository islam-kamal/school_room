...
import 'package:school_room/Feature/Student/Groups/presentation/pages/student_group_conversation_screen.dart';
...
class GroupsListViewItem extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        customAnimatedPushNavigation(context, StudentGroupConversationScreen());
      },
      child: Column(
